...
- ❓ Falta de información sobre cómo movilizarse en las diferentes rutas.  

**JuarezGO** busca resolver estos problemas ofreciendo a la comunidad una aplicación sencilla y práctica que muestre toda la información necesaria sobre el transporte público:

- 🚏 Paradas obligatorias de cada línea de camiones.  
- ⏱ Intervalos de tiempo en los que pasa cada unidad.  
- 🛣 Calles y trayectos por los que circula cada ruta.  
